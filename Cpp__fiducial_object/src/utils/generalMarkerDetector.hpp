...
/** @brief
    ...
    * --- ! ---
*/
class FIDUCIALOBJECT_API GeneralMarkerDetector {
    public:
         GeneralMarkerDetector(){};
        ...
        // To MODIFY (Optional)
            ...
            virtual  std::string getMarkerLabelerDict(){return ""; };
            ...
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
            virtual  float getEstimatedPosesDifferenceThreshold(){ return 0.6; };


        // Already IMPLEMENTED
             std::vector<int> getDetectedIds(){ return this->_detectedMarkersIds; };
             void setDetectedMarkers(std::vector<general_marker::GeneralMarker> newMarkers){ this->_detectedMarkers = newMarkers; };
             std::vector<general_marker::GeneralMarker> getDetectedMarkers(){ return this->_detectedMarkers; };
            ...
            // Markers - config
             int getMarkerConfigById(int id){
