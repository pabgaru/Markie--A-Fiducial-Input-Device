...
public:
    ...
    virtual void setTransform(Transform t){_transform=t;}//priority 1 is higher than 2
    ...
    virtual bool getBoundingBox(Point3f&min,Point3f&max){(void)min;(void)max; return false;}
