...
namespace aruco_mm{
    ...
    namespace debug{
        ...
        private:
            ...
            static std::function<void(std::string)> _msgfunc;
        public:
            static void init();
            static void setLevel(int l);
            static int getLevel();
            static void setPrintFunction(std::function<void(std::string)> msgfunc );
        ...
        if (aruco_mm::debug::Debug::getLevel()>=level){\
                ...
                sstr<<__func__<<":"<< aruco_mm::debug::Debug::getFileName(__FILE__)<<":"<<__LINE__  <<":  "<<x<<std::endl; \
                aruco_mm::debug::Debug::print(sstr.str());\
                }}
