...
namespace aruco_mm{
    ...
    */
    ...
    //// --------------------------------------------------------
    void IoHelper::toStream(const general_marker::GeneralMarker &m,std::ostream &str){
        uint32_t s=m.size();
    ...
    void  IoHelper::fromStream(general_marker::GeneralMarker &m,std::istream &str){
        uint32_t s;
