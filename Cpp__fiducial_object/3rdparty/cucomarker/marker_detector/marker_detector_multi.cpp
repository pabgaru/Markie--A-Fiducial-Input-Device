...
int main(int argc, char **argv)
{
    ...
    for(auto config: splitConfigurationsString(argv[2])){
        MDetector.loadConfigFile(config);
    }           
    ...
    do{
        ...
        // Print information on frame
        int linePoint=15; int step=15; cv::Scalar frameTextColor(88,2,237);
        cv::putText(image, "Frame: "+std::to_string(processedFrames), cv::Point2f(5,linePoint), cv::FONT_HERSHEY_PLAIN, 1, frameTextColor, 1, false); linePoint+=step;
